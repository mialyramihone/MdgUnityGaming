...
interface FormulaireInscriptionFeminaProps {
  tournoiId: number;
  tournoiTitre: string;
  onClose?: () => void;
  onSuccess?: () => void;
...
export default function FormulaireInscriptionFemina({ tournoiId, tournoiTitre, onClose, onSuccess }: FormulaireInscriptionFeminaProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="rounded-2xl max-w-md w-full" style={{ backgroundColor: '#ffffff', border: '2px solid #f8c741' }}>
        ...
        {/* Message d'info spécifique au tournoi Femina */}
        <div className="mx-6 mt-4 p-3 bg-orange-50 rounded-lg">
          <p className="text-xs text-orange-700">
            ⏰ Inscriptions jusqu&apos;au 7 Mars 2026 à 22h00
          </p>
          <p className="text-xs text-orange-700 mt-1">
            🎮 Tournoi en équipe - Les équipes seront formées par tirage au sort
          </p>
        </div>
